...
function layoutBracket(targetSelector) {
    ...
    rounds.forEach((roundEl) => {
        ...
        const roundWidth = CONFIG.SVG_WIDTH + (CONFIG.MATCH_MARGIN_X * 2) + CONFIG.ROUND_GAP;
...
// **FUNÇÃO DE CONECTORES REESCRITA PARA SEGUIR A SUA LÓGICA FINAL**
function drawConnectors(targetSelector) {
    ...
    // 1. Desenha todos os segmentos horizontais
    ...
    // 2. Desenha os segmentos verticais, apenas quando a chave afunila
