// js/main.js - Versão final com distinção de modo de Edição e Visualização
...
let isEditMode = false; // Flag para controlar o modo atual
...
async function loadAndDisplayBracket(id) {
    ...
    // Gerencia a visibilidade dos botões de admin
